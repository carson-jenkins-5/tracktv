        ...
        try {
            ...
            trendingShows.forEach(show => {
                ...
                div.innerHTML = `
                    ...
                    <button class="explore-add-button" onclick="addToWatchlist('${show.id}', '${show.name}', '${show.poster_path}', 'show')">+</button>
                `;
                topShowsContainer.appendChild(div);
            });
        } catch (error) {
        ...
        try {
            ...
            trendingMovies.forEach(movie => {
                ...
                div.innerHTML = `
                    ...
                    <button class="explore-add-button" onclick="addToWatchlist('${movie.id}', '${movie.title}', '${movie.poster_path}', 'movie')">+</button>
                `;
